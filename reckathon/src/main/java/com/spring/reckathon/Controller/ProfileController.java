...
public class ProfileController {
	...
	public String updatedegree(@RequestParam("degree") String degree, HttpSession session) {
		service.updatedegree(degree, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}

	@PostMapping("updateFieldOfStudy")
	public String updateFieldOfStudy(@RequestParam("fieldOfStudy") String fieldOfStudy, HttpSession session) {
		service.updateFieldOfStudy(fieldOfStudy, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}

	@PostMapping("updateInstitute")
	public String updateInstitute(@RequestParam("institute") String institute, HttpSession session) {
		service.updateInstitute(institute, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}
	
	@PostMapping("updateStartDate")
	public String updateStartDate(@RequestParam("startDate") String startDate, HttpSession session) {
		service.updateStartDate(startDate, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}
	
	@PostMapping("updateEndDate")
	public String updateEndDate(@RequestParam("endDate") String endDate, HttpSession session) {
		service.updateEndDate(endDate, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}
	
	@PostMapping("updatePercentage")
	public String updatePercentage(@RequestParam("percentage") String percentage, HttpSession session) {
		service.updatePercentage(percentage, session.getAttribute("email").toString());
		return "redirect:/education-details";
	}
