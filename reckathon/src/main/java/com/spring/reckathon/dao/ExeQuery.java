...
public class ExeQuery {
	...
	public void updatedegree(String degree, String email) {
		String query = "UPDATE education SET degree = ? where email = ?";
		jdbcTemplate.update(query, degree, email);
	}

	public void updateFieldOfStudy(String fieldOfStudy, String email) {
		String query = "UPDATE education SET fieldOfStudy = ? where email = ?";
		jdbcTemplate.update(query, fieldOfStudy, email);
	}

	public void updateInstitute(String institute, String email) {
		String query = "UPDATE education SET institute = ? where email = ?";
		jdbcTemplate.update(query, institute, email);
	}

	public void updateStartDate(String startDate, String email) {
		String query = "UPDATE education SET start_date = ? where email = ?";
		jdbcTemplate.update(query, startDate, email);
	}

	public void updateEndDate(String endDate, String email) {
		String query = "UPDATE education SET end_date = ? where email = ?";
		jdbcTemplate.update(query, endDate, email);
	}

	public void updatePercentage(String percentage, String email) {
		String query = "UPDATE education SET percentage = ? where email = ?";
		jdbcTemplate.update(query, percentage, email);
	}
